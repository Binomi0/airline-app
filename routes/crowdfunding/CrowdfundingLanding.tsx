...
const CrowdfundingLanding = () => {
  ...
  const [raised, setRaised] = useState(156750)
  const goal = 500000
  const [daysRemaining, setDaysRemaining] = useState(30)
  const [investorCount, setInvestorCount] = useState(1234)
    ...
    <div className={styles.root}>
      ...
      <header className={styles.header}>
        <div className={styles.navContent}>
          ...
          <nav className={styles.navList}>
            <a href="#problema" className={styles.navLink}>Problema</a>
            <a href="#solucion" className={styles.navLink}>Solución</a>
        ...
        <Container className={styles.heroContent}>
          ...
          >
            <div className={styles.metric}>
              ...
              <span className={styles.metricValue}>$500,000 <small style={{fontSize: '0.4em'}}>USDC</small></span>
            </div>
            <div className={styles.metric}>
            ...
            <div className={styles.progressWrapper}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '8px', fontSize: '0.8rem', color: 'var(--cf-text-muted)' }}>
      ...
      <section id="problema" className={styles.section}>
        <div className={styles.splitScreen}>
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Typography variant="h2" className={`${styles.title} ${styles.sectionTitle}`} style={{ textAlign: 'left', marginBottom: '40px' }}>
              La simulación aérea está rota
            </Typography>
            <ul className={styles.problemList}>
              <li className={styles.problemItem}>
                <div className={styles.problemIcon}><TrendingUp /></div>
              ...
              <li className={styles.problemItem}>
                <div className={styles.problemIcon}><Groups /></div>
                <div className={styles.problemText}>
              ...
              <li className={styles.problemItem}>
                <div className={styles.problemIcon}><Verified /></div>
                <div className={styles.problemText}>
              ...
              <li className={styles.problemItem}>
                <div className={styles.problemIcon}><Timer /></div>
                <div className={styles.problemText}>
          ...
          >
            <Image 
              src="/img/sim_comparison.png" 
              alt="Problem Comparison" 
              fill 
        ...
        <div className={styles.tokenomicsLayout}>
          <div className={styles.chartPlaceholder}>
            ...
            <svg width="400" height="400" viewBox="0 0 400 400">
              ...
              <text x="200" y="190" textAnchor="middle" fill="#fff" fontSize="24" fontWeight="800">AIRL</text>
              <text x="200" y="220" textAnchor="middle" fill="var(--cf-text-muted)" fontSize="14">Total Supply</text>
            </svg>
            <div style={{ position: 'absolute', bottom: -20, display: 'flex', flexWrap: 'wrap', gap: '16px', justifyContent: 'center' }}>
               {distribution.map((d, i) => (
          ...
          <div>
            ...
            <Box mt={6} p={4} sx={{ borderRadius: '24px', background: 'rgba(42, 125, 225, 0.1)', border: '1px solid var(--cf-secondary)' }}>
              <Typography variant="h6" className={styles.title} mb={2}>Calculadora de Staking</Typography>
              <Grid container spacing={3} alignItems="center">
                <Grid item xs={12} sm={8}>
                  <Typography variant="body2" color="var(--cf-text-muted)" mb={1}>Cantidad de AIRL a stakear</Typography>
                  <input 
                    type="range" 
                    min="100" 
                    max="10000" 
                ...
                <Grid item xs={12} sm={4}>
                   <Typography variant="h5" align="right" className={styles.mono}>{investmentAmount} <small>AIRL</small></Typography>
                </Grid>
                <Grid item xs={12}>
                   <Box sx={{ borderTop: '1px solid rgba(255,255,255,0.1)', pt: 2, display: 'flex', justifyContent: 'space-between' }}>
                      <Typography variant="body2" color="var(--cf-text-muted)">Ganancia diaria estimada:</Typography>
                      <Typography variant="h6" color="#34D399" className={styles.mono}>+{(investmentAmount * 0.05).toFixed(2)} AIRG</Typography>
                   </Box>
                </Grid>
              </Grid>
            </Box>
              ...
              <div className={styles.roadmapBox}>
                ...
                <ul className={styles.roadmapList}>
                  {step.items.map((item, j) => (
                    <li key={j}><Verified sx={{ fontSize: 16, color: 'var(--cf-secondary)' }} /> {item}</li>
                  ))}
                </ul>
              </div>
            </motion.div>
        ...
        <div className={styles.tiers}>
           ...
           <div className={styles.tierCard}>
              ...
              <ul className={styles.tierList}>
                <li><ChevronRight /> Tokens AIRL a precio seed</li>
                <li><ChevronRight /> Acceso Discord comunidad</li>
                <li><ChevronRight /> NFT de bienvenida</li>
              </ul>
              <Button variant="outlined" color="inherit" fullWidth sx={{ borderRadius: '12px', py: 2 }}>Seleccionar</Button>
           </div>
           
           {/* Tier 2 */}
           <div className={`${styles.tierCard} ${styles.featured}`}>
              <div style={{ position: 'absolute', top: 20, right: 20, background: 'var(--cf-accent)', padding: '4px 12px', borderRadius: '20px', fontSize: '0.7rem' }}>POPULAR</div>
              <span className={styles.tierName}>PILOTO</span>
              <span className={styles.tierPrice}>$1,000</span>
              <ul className={styles.tierList}>
                <li><Verified sx={{ color: '#34D399', fontSize: 18 }} /> Todo de Cadete</li>
                <li><Verified sx={{ color: '#34D399', fontSize: 18 }} /> Licencia NFT Nivel 1 (C172)</li>
                <li><Verified sx={{ color: '#34D399', fontSize: 18 }} /> 5% bonus tokens</li>
                <li><Verified sx={{ color: '#34D399', fontSize: 18 }} /> Acceso Early Beta</li>
              </ul>
              <Button variant="contained" sx={{ background: 'var(--cf-accent)', color: '#fff', borderRadius: '12px', py: 2 }}>Invertir Ahora</Button>
           </div>
           ...
           <div className={styles.tierCard}>
              ...
              <ul className={styles.tierList}>
                <li><Verified sx={{ color: 'var(--cf-secondary)', fontSize: 18 }} /> Todo de Piloto</li>
                <li><Verified sx={{ color: 'var(--cf-secondary)', fontSize: 18 }} /> Aeronave C700 NFT</li>
                <li><Verified sx={{ color: 'var(--cf-secondary)', fontSize: 18 }} /> 10% bonus tokens</li>
                <li><Verified sx={{ color: 'var(--cf-secondary)', fontSize: 18 }} /> Votación prioritaria</li>
              </ul>
              <Button variant="outlined" color="secondary" fullWidth sx={{ borderRadius: '12px', py: 2 }}>Seleccionar</Button>
           </div>
        </div>
      </section>
        ...
        <Grid container spacing={4} justifyContent="center">
          {[
            ...
            <Grid item xs={6} sm={3} key={i}>
              <Box textAlign="center" sx={{ p: 4, borderRadius: '24px', background: 'var(--cf-glass-bg)', border: '1px solid var(--cf-glass-border)' }}>
                 <div style={{ fontSize: '3rem', marginBottom: '20px' }}>{member.icon}</div>
                 <Typography variant="h6" className={styles.title}>{member.name}</Typography>
                 <Typography variant="body2" color="var(--cf-text-muted)">{member.role}</Typography>
              </Box>
            </Grid>
          ))}
        </Grid>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.faqGrid}>
          {[
            { q: '¿Cómo sé que no es un scam?', a: 'Todos nuestros contratos están auditados por ConsenSys Diligence y son de código abierto en GitHub. La liquidez estará bloqueada por 2 años.' },
            { q: '¿Qué simuladores están soportados?', a: 'Actualmente soportamos Microsoft Flight Simulator (2020/2024), X-Plane 11/12 y Prepar3D v5/v6.' },
            { q: '¿Necesito hardware especial?', a: 'No, cualquier PC capaz de correr los simuladores mencionados es suficiente. Nuestra app de tracking consume recursos mínimos.' },
            { q: '¿Cómo se verifican los vuelos?', a: 'Usamos un oráculo personalizado que lee los datos de telemetría del simulador y los cruza con datos de tráfico real e IA para asegurar que el vuelo fue operado manualmente.' },
          ].map((faq, i) => (
            <Accordion key={i} sx={{ background: 'var(--cf-glass-bg)', color: '#fff', border: '1px solid var(--cf-glass-border)', mb: 2, borderRadius: '16px !important', '&:before': { display: 'none' } }}>
          ...
          <Grid container spacing={8}>
            <Grid item xs={12} md={4}>
              ...
              <Box mt={4} display="flex" gap={2}>
                <Button size="small" variant="outlined" color="inherit">Twitter</Button>
                <Button size="small" variant="outlined" color="inherit">Discord</Button>
                <Button size="small" variant="outlined" color="inherit">Github</Button>
              </Box>
            </Grid>
            <Grid item xs={6} md={2}>
               <Typography fontWeight={800} mb={3}>Plataforma</Typography>
            ...
            <Grid item xs={6} md={2}>
               <Typography fontWeight={800} mb={3}>Recursos</Typography>
               <ul style={{ listStyle: 'none', padding: 0, color: 'var(--cf-text-muted)', lineHeight: '2.5' }}>
                 <li>Whitepaper</li>
                 <li>Auditoría</li>
                 <li>Guía</li>
            ...
            <Grid item xs={12} md={4}>
               <Typography fontWeight={800} mb={3}>Boletín de Vuelo</Typography>
               <div style={{ display: 'flex', gap: '8px' }}>
                  <input type="email" placeholder="Email..." style={{ flex: 1, padding: '12px', borderRadius: '8px', border: '1px solid var(--cf-glass-border)', background: 'rgba(255,255,255,0.05)', color: '#fff' }} />
                  <Button variant="contained" sx={{ background: 'var(--cf-accent)' }}>Suscribir</Button>
               </div>
            </Grid>
          </Grid>
          <Box mt={10} pt={4} sx={{ borderTop: '1px solid var(--cf-glass-border)', display: 'flex', justifyContent: 'space-between', color: 'var(--cf-text-muted)', fontSize: '0.8rem' }}>
