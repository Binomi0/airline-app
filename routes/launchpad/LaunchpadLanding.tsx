    ...
    <div className={styles.root}>
      ...
      <header className={styles.header}>
        <div className={styles.navContent}>
          ...
          <nav className={styles.navLinks}>
            <a href='#ecosistema' className={styles.navLink}>
              Ecosistema
            </a>
            <a href='#funciona' className={styles.navLink}>
              Cómo Funciona
            </a>
            <Link
              href='/crowdfunding'
      ...
      <section className={styles.problemSection}>
        ...
        <div className={styles.problemQuote}>
          &quot;Los simuladores de vuelo son increíbles, pero... vuelas solo, sin recompensas reales, sin progresión
          económica.&quot;
        </div>
        <div className={styles.solutionCard}>
          <p className={styles.sectionDesc}>
            <strong>Weifly soluciona esto.</strong> Añadimos una capa económica real con tokens, progresión profesional
            mediante licencias NFT y una comunidad descentralizada que gobierna el futuro de la aerolínea.
          </p>
        </div>
      </section>
        ...
        <div className={styles.stepsGrid}>
          <div className={styles.stepCard}>
            ...
            <p className={styles.stepDesc}>
              Solo con tu email. Creamos tu wallet automáticamente. La proteges con Passkey (biometría de tu
              dispositivo) sin contraseñas débiles.
            </p>
          </div>
          ...
          <div className={styles.stepCard}>
            ...
            <p className={styles.stepDesc}>
              Compra o gana NFTs de licencias (Rangos 1 a 4). Desbloquea aeronaves icónicas desde una C172 hasta un
              B737.
            </p>
          </div>
          ...
          <div className={styles.stepCard}>
            ...
            <p className={styles.stepDesc}>
              Conéctate con nuestra app Electron, vuela en MSFS o X-Plane. Al aterrizar, ganas tokens AIRL y un NFT de
              logro de tu ruta.
            </p>
          </div>
        </div>
      ...
      <section id='tokens' className={styles.tokensSection}>
        <div className={styles.tokensContainer}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDesc}>
              Un ecosistema de dos tokens diseñado para el crecimiento y la utilidad real.
            </p>
          </div>
      ...
      <section id='roadmap' className={styles.roadmapSection}>
        ...
        <div className={styles.roadmapContainer}>
          ...
          <div className={styles.roadmapItem}>
            ...
            <p className={styles.roadmapContent}>
              Lanzamiento del registro email/passkey, venta privada (cap $100) y activación del staking.
            </p>
          </div>
          ...
          <div className={styles.roadmapItem}>
            ...
            <p className={styles.roadmapContent}>
              Minting de licencias y aviones iniciales. Primeros vuelos monitorizados con la app Electron.
            </p>
          </div>
          ...
          <div className={styles.roadmapItem}>
            ...
            <p className={styles.roadmapContent}>
              Listado en Uniswap (AIRL), airdrop retroactivo para pilotos de prueba y apertura masiva.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerLinks}>
            ...
            <ul>
              <li>
                <Link href='/hangar'>Hangar</Link>
              </li>
              <li>
                <Link href='/license'>Licencias</Link>
              </li>
              <li>
                <Link href='/gas'>Combustible</Link>
              </li>
            </ul>
          </div>
          <div className={styles.footerLinks}>
            ...
            <ul>
              <li>
                <a href='https://discord.gg/weifly'>Discord</a>
              </li>
              <li>
                <a href='https://twitter.com/weifly'>Twitter</a>
              </li>
              <li>
                <a href='https://github.com/weifly'>Github</a>
              </li>
            </ul>
          </div>
          <div className={styles.footerLinks}>
