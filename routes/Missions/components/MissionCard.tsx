...
import { Card, CardContent, Typography, Box, Chip, Stack, useTheme, alpha } from '@mui/material'
...
const MissionCard: React.FC<MissionCardProps> = ({ mission, onSelect, isSelected }) => {
  ...
  const borderColor = isSponsored ? theme.palette.success.main : theme.palette.divider
