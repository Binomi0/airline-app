      ...
      <Container maxWidth='lg'>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Typography variant='h6' color='text.secondary' paragraph sx={{ mb: 4, maxWidth: '500px' }}>
                Conecta tu simulador (MSFS, X-Plane, P3D) directamente con el ecosistema WeiFly. 
                Nuestra aplicación de escritorio gestiona la telemetría en tiempo real y tus recompensas on-chain.
              </Typography>
            ...
            >
              ...
              >
                <Box 
                  ...
                  onError={(e: any) => { e.target.src = 'https://placehold.co/600x400/1e293b/white?text=App+Preview' }}
                />
              </Paper>
            </motion.div>
          </Grid>
        ...
        <Box mt={10}>
          ...
          <Grid container spacing={4} mt={2}>
            {[
              { icon: <ComputerIcon color='primary' />, title: 'Conexión Directa', desc: 'Sincronización instantánea con SimConnect y FSUIPC sin configuraciones complejas.' },
              { icon: <ComputerIcon color='primary' />, title: 'Seguridad Local', desc: 'Tus llaves privadas nunca salen de tu dispositivo. Firma transacciones localmente.' },
              { icon: <ComputerIcon color='primary' />, title: 'Bajo Consumo', desc: 'Optimizada para correr en segundo plano sin afectar el rendimiento de tu simulador.' }
            ].map((f, i) => (
              <Grid item xs={12} md={4} key={i}>
                <Paper variant='outlined' sx={{ p: 4, borderRadius: 6, height: '100%', bgcolor: 'rgba(255,255,255,0.02)' }}>
                  <Box mb={2}>{f.icon}</Box>
