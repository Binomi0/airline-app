        ...
        <Paper>
          <Box p={2}>
            ...
            <Typography variant='body1' paragraph>
              DecentralAir is a decentralized virtual airline powered by blockchain technology. We`re revolutionizing
              the aviation industry by providing users with ownership and control over their virtual aircraft,
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <Typography variant='body2' color='textSecondary' paragraph>
                  <strong>Decentralized Ownership:</strong> With DecentralAir, you truly own your virtual aircraft as
                  non-fungible tokens (NFTs) on the blockchain. No centralized authority can take away your ownership
                  rights.
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant='body2' color='textSecondary' paragraph>
                  <strong>Transparent Operations:</strong> Our platform leverages blockchain technology to provide
                  transparent and immutable records of flight operations, ticket sales, and aircraft ownership.
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant='body2' color='textSecondary' paragraph>
                  <strong>Community-Driven Governance:</strong> DecentralAir is governed by its community of users.
                  Through decentralized decision-making mechanisms, users have a say in the direction of the platform
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            <Paper elevation={3} sx={{ padding: 2 }}>
              ...
              <Typography variant='body1' paragraph>
                Browse available flights, select your desired route and dates, and book your tickets using Ethereum or
          ...
          <Grid item xs={12} md={4}>
            <Card>
              <CardContent>
                ...
                <Typography variant='body1' paragraph>
                  DecentralAir offers lower fees and more transparent pricing compared to traditional airlines, thanks
                  to its decentralized nature and blockchain technology.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
