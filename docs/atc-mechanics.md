...
- **Objetivo:** Evitar el _farming_ (conectarse a un aeropuerto vacío y quedarse AFK) y fomentar que los ATCs se posicionen en aeropuertos que la comunidad de WeiFly frecuenta.
...
- **Mecánica:** WeiFly (o DAOs/Aerolíneas en el ecosistema) puede publicar "Misiones" usando fondos del _Marketing & Referral Pool_. Por ejemplo: `"Cobertura total pedida en EHAM de 18:00 a 20:00Z"`.
...
Tras una interacción, los pilotos pueden otorgar _Kudos_ específicos, en lugar de un rating numérico:
