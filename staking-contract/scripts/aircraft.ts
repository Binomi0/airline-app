import { deployAircraftNFT, lazyMintAircraft, mintAircraft, setClaimConditionsAircraft } from '../utils'
import { AirlineCoin, LicenseNFT } from '../typechain-types'
import { SignerWithAddress } from '@nomiclabs/hardhat-ethers/signers'

const deployAircraft = async (accounts: SignerWithAddress[], airlineCoin: AirlineCoin, license: LicenseNFT) => {
