import { deployLicenseNFT, lazyMintLicense, mintLicense, setClaimConditionsLicense } from '../utils'
import { AirlineCoin } from '../typechain-types'
import { SignerWithAddress } from '@nomiclabs/hardhat-ethers/signers'

const deployLicense = async (accounts: SignerWithAddress[], airlineCoin: AirlineCoin) => {
